...
def simple_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    score = player_score + take_turn(num_rolls, player_score, opponent_score, dice=dice)
    return score
...
def sus_points(score):
    ...
    "*** YOUR CODE HERE ***"
    i = score
    if num_factors(i) != 3 and num_factors(i) != 4:
        return i
    while i:
        if is_prime(i):
            return i
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    t = simple_update(num_rolls, player_score, opponent_score, dice=dice)
    return sus_points(t)
    # END PROBLEM 4
