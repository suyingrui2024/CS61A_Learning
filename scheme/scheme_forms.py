...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        "*** YOUR CODE HERE ***"
        the_value = scheme_eval(expressions.rest.first, env)
        env.define(signature,the_value)
        return signature
        # END PROBLEM 4
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        the_name = signature.first
        the_formal = signature.rest
        auguments = expressions.rest
        value_to_bind = do_lambda_form(Pair(the_formal,auguments),env)
        env.define(the_name, value_to_bind)
        return the_name
        # END PROBLEM 10
    else:
...
def do_lambda_form(expressions, env):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    myreturn = LambdaProcedure(formals, expressions.rest, env)
    return myreturn
    # END PROBLEM 7
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        value = bindings.first.rest.first
...
def do_mu_form(expressions, env):
    ...
    # BEGIN PROBLEM 11
    "*** YOUR CODE HERE ***"
    to_returned = MuProcedure(formals,expressions.rest)
    return to_returned
